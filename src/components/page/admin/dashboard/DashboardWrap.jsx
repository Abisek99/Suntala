                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-9">
                                <div className="tab-content" id="v-pills-tabContent">
                                    ...
                                    {apiUser &&
                                        (apiUser.roleUser === 'staff' || apiUser.roleUser === 'user') &&
                                        <ProfileContent user={apiUser}/>}
                                    {apiUser &&
                                        (apiUser.roleUser === 'staff' || apiUser.roleUser === 'admin') && <AddProduct/>}
                                    {apiUser &&
                                    ...
                                    {apiUser &&
                                        (apiUser.roleUser === 'staff' || apiUser.roleUser === 'admin') && <BidList/>}
                                    {/*<BidList/>*/}
                                    {/* <UsersList /> */}
                                </div>
                            </div>
