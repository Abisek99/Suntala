...
function SignUpWrap() {
    ...
    const handleImageUpload = async (e) => {
        ...
        if (checkFileSize(imageFile)) {
            ...
            console.log('🚀 ~ file: AddProduct.jsx:64 ~ handleImageUpload ~ data:', data)
    ...
    const uploadImage = async (imgUrl) => {
        ...
        try {
            await axios.post(`${url.proxy_api}user/docs`, docValues)
                .then((res) => {
                    console.log(res)
                            ...
                            >
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="form-inner">
                                                ...
                                                >
                                                    <option className={'selectBtn'} value="License">License</option>
                                                    <option className={'select-option'} value="Citizenship">Citizenship</option>
                                                    <option className={'select-option'} value="Passport">Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                ...
                                <div className="form-poicy-area">
                                    <p>
                                        ...
                                        Hajur Ko Car Rental account, and you agree to Hajur Ko Car Rental's <Link
                                        to={'#'}>Terms &amp; Conditions</Link>{' '}
